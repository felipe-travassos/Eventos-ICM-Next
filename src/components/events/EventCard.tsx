...
const EventCard: React.FC<EventCardProps> = ({
    ...
    const isPendingApproval = userRegistration?.status === 'pending'; // ✅ NOVO
    const isApproved = userRegistration?.status === 'approved'; // ✅ NOVO
                ...
                {showRegistration && (
                    <div className="mt-4">
                        {userData ? (
                            // USUÁRIO LOGADO
                            isPendingApproval ? (
                                // ✅ NOVO: Status Pendente de Aprovação
                                <div className="bg-yellow-100 text-yellow-800 p-3 rounded-lg border border-yellow-300 text-center">
                                    ...
                                    <p className="text-sm mt-1">Sua inscrição está em análise</p>
                                </div>
                            ) : isUserRegistered ? (
                                <div className="bg-green-100 text-green-800 p-2 rounded text-center">
                                    ...
                                    {isApproved ? '✅ Inscrição aprovada!' : 'Você já está inscrito neste evento!'}
                                </div>
